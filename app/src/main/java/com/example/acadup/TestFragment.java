...
public class TestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_test, container, false);
            ...
            Query query = firestore.collection("users").document(FirebaseAuth.getInstance().getUid()).collection("Attempted Tests");
            ...
            adapter = new FirestoreRecyclerAdapter<SubjectChaptersModel, PrevPDFViewHolder>(options) {
                ...
                protected void onBindViewHolder(@NonNull @NotNull PrevPDFViewHolder holder, int position, @NonNull @NotNull SubjectChaptersModel model) {
                    holder.testName.setText(model.getName());
                    holder.testScore.setText("Score : "+model.getScore());
                    ...
                    //Glide.with(getContext()).load(android.R.d).into(holder.image);
